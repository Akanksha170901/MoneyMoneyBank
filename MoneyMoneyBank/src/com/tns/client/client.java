...
public class client {
	...
	public static void main(String[] args) {
		...
		// Objects
		MMCurrentAcc mcAcc = new MMCurrentAcc(0371, "Akanksha", accBal, creditLimit);
		MMSavingAcc msAcc = new MMSavingAcc(0021, "Shruti", accBal, true);
		...
		case 1:// Create new Account
			...
			case 1:
				...
				accBal = sc.nextFloat();
				while (accBal < MMSavingAcc.getMinbal()) {
					if (accBal < MMSavingAcc.getMinbal()) {
